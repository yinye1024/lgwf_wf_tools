...
class PromptUpgradeScriptsTest(unittest.TestCase):
    ...
    def test_prompt_upgrade_workflow_uses_owned_namespace_and_confirmation(self) -> None:
        ...
        self.assertIn("REVIEW confirm_prompt_upgrade", confirm_source)
        self.assertNotIn("APPROVAL confirm_prompt_upgrade", confirm_source)
        self.assertIn('PERSIST ".lgwf/prompt_upgrade/decision_review.json"', confirm_source)
