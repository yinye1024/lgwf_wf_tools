...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "lgwf_wf_create_fast.raw_intent_request": raw_intent_request,
                "lgwf_wf_create_fast.creation_context_dirs": creation_context_dirs,
                "lgwf_wf_create_fast.creation_context_files": creation_context_files,
                "lgwf_wf_create_fast.raw_intent_finished": True,
            },
            ensure_ascii=False,
            indent=2,
        )
