...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "lgwf_wf_create_fast.raw_intent_revision_result": result,
                "lgwf_wf_create_fast.raw_intent_request_proposal": result["proposal"],
                "lgwf_wf_create_fast.raw_intent_confirmation_context": context,
            },
            ensure_ascii=False,
            indent=2,
        )
