"""将需求方案的 revise 决策写回 canonical proposal。"""
...
def main() -> None:
    ...
    result = write_revised_proposal(
        ...
        approval_key="create_requirements_approval",
    ...
    print(
        json.dumps(
            {
                "lgwf_wf_create_fast.requirements_revision_result": result,
                "lgwf_wf_create_fast.create_requirements_proposal": result["proposal"],
                "lgwf_wf_create_fast.requirements_revision_context": context,
                "lgwf_wf_create_fast.requirements_confirmation_context": context,
            },
            ensure_ascii=False,
            indent=2,
        )
