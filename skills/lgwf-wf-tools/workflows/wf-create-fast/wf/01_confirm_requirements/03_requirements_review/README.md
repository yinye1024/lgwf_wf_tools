...
- `state.lgwf_wf_create_fast.requirements_confirmation_context`

## 输出

- `state.lgwf_wf_create_fast.requirements_confirmation_context`
- `state.lgwf_wf_create_fast.requirements_revision_context`
- `state.lgwf_wf_create_fast.requirements_revision_result`
- `state.lgwf_wf_create_fast.create_requirements`
