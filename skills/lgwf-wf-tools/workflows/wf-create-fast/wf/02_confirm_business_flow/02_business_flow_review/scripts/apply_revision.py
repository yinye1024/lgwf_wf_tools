...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "lgwf_wf_create_fast.business_flow_revision_result": result,
                "lgwf_wf_create_fast.business_flow_proposal": result["proposal"],
                "lgwf_wf_create_fast.business_flow_revision_context": context,
                "lgwf_wf_create_fast.business_flow_confirmation_context": context,
            },
            ensure_ascii=False,
            indent=2,
        )
