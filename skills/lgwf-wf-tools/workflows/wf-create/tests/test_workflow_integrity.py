...
class WorkflowCreateIntegrityTest(unittest.TestCase):
    ...
    def test_confirm_step_designs_subflows_declare_local_responsibilities(self) -> None:
        expectations = {
            ...
            "step_design_proposal": (
                ...
                'CONTEXT workspace file ".lgwf/step_design_proposal_react_context.json"',
    ...
    def test_step_design_stage_uses_only_confirmed_business_inputs(self) -> None:
        ...
        prompt = (
            ROOT / "03_confirm_step_designs/02_step_design_proposal/agents/design_steps_react.md"
        ).read_text(encoding="utf-8")
        validator = (
            ROOT
            / "03_confirm_step_designs/02_step_design_proposal/scripts/validate_step_designs_proposal.py"
        ).read_text(encoding="utf-8")
    ...
    def test_step_design_and_implementation_use_dsl_assist_context(self) -> None:
        ...
        self.assertIn('PROMPT "agents/design_steps_react.md"', proposal_workflow)
        self.assertRegex(
            proposal_workflow,
