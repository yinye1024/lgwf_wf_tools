...
def build_context(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "repair_instruction": (
            ...
            else "根据 failed_checks 修复 .lgwf/create_requirements_proposal.json；不要扩大到业务流、步骤设计或实现。"
        ),
    }
...
def main() -> None:
    ...
    print(json.dumps({"lgwf_wf_create.requirements_proposal_react_context": context}, ensure_ascii=False, indent=2))
