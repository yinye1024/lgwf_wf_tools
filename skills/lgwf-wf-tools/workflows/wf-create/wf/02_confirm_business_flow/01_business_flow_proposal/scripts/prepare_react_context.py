...
def build_context(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "repair_instruction": (
            ...
            else "根据 failed_checks 修复 .lgwf/business_flow_proposal.json；不要扩大到步骤设计、脚手架或实现。"
        ),
    }
...
def main() -> None:
    ...
    print(json.dumps({"lgwf_wf_create.business_flow_proposal_react_context": context}, ensure_ascii=False, indent=2))
