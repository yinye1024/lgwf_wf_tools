...
def main() -> int:
    ...
    parser.add_argument("--workflow-tests-baseline", default="workflows/self-improve/workflow-health/baseline.json")
    ...
    commands: list[tuple[str, list[str] | str]] = [
        ...
        ("collect_changed_files", ["workflows/self-improve/scripts/collect_changed_files.py", "--output", str(changed_files)]),
        (
            "run_self_evals",
            [
                "workflows/self-improve/scripts/run_self_evals.py",
                "--changed-files",
                str(changed_files),
                "--check-overrides",
                "--output-dir",
    ...
    if args.run_workflow_tests:
        commands.append(
            (
                "workflow_tests",
                [
                    "workflows/self-improve/scripts/run_workflow_tests.py",
                    "--baseline",
    ...
    commands.extend(
        ...
        (
            ...
            [
                "workflows/self-improve/scripts/write_upgrade_report.py",
                "--version",
                args.version,
                "--source",
                args.source,
