...
## goal
定义 package 级共享技术底座和验证边界，确保 `wf-audit-fix` 在真正实现各阶段前就已经固定 `README.md`、`AGENTS.md`、`entry_contract.json`、`tests/` 和 `wf/shared/scripts/dsl_upgrade_common.py` 的职责分层、状态边界和最小验收命令。
