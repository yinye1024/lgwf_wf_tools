...
'''
    ...
    def test_route_contracts_are_declared(self) -> None:
        ...
        self.assertIn("ROUTE select_scope_branch READ state.wf_audit_fix.scope_route", root_workflow)
        ...
        self.assertIn("READ state.wf_audit_fix.scope_confirmation_context", confirm_workflow)
        self.assertIn("WRITE state.wf_audit_fix.scope_approval", confirm_workflow)
    ...
    def test_scope_gate_persists_scope_approval(self) -> None:
        ...
        self.assertIn("RESULT state.wf_audit_fix.confirm_scope_result", text)
        self.assertIn("WRITE state.wf_audit_fix.scope_approval", text)
    ...
    def test_summary_receives_object_input_not_target_results_list(self) -> None:
        ...
        self.assertIn("INPUT state.wf_audit_fix", text)
        self.assertNotIn("INPUT state.wf_audit_fix.target_results", text)
