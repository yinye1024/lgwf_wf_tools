...
def main() -> None:
    root = Path.cwd()
    lgwf_dir = root / ".lgwf"
    proposal_path = lgwf_dir / "wf_create_fast_input_proposal.json"
    confirmed_path = lgwf_dir / "wf_create_fast_input.json"
    ...
    result = {
        "decision": "approve",
        "proposal_path": ".lgwf/wf_create_fast_input_proposal.json",
        "confirmed_path": ".lgwf/wf_create_fast_input.json",
    }
