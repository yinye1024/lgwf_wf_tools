...
```powershell
python C:\Users\Administrator\.codex\skills\lgwf-client-assist\scripts\lgwf.py audit plugins\team-skills\skills\lgwf-e2e-test-generator\workflow.lgwf
python -m unittest discover plugins\team-skills\skills\lgwf-e2e-test-generator\tests
```
