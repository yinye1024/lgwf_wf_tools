                    ...
                    "writes": {
                        ".lgwf/request_scope_capture.json": {
                            "repository_input_context": {
                                "repo_hint": "plugins/team-skills/skills/git-diff-brief",
                                "workspace_root": "plugins/team-skills/skills/git-diff-brief",
                            },
                            "summary_scope": {
...
class GitDiffBriefRuntimeFakeE2ETest(unittest.TestCase):
    ...
    def _launch(self, scenario_id: str) -> tuple[ExitStack, dict[str, str], Path, Path, dict[str, Any]]:
        ...
        for attempt in range(1, 4):
            ...
            case_input_path = work_dir / ".lgwf" / "case_input.json"
