    ...
    output_state(
        {
            "self_fix_request_context": {
                ...
                "optional_fields": {
                    ...
                    "ask_main_agent_for_target_approvals": "Whether lgwf-wf-agent should forward target workflow APPROVAL requests to the main agent for confirmation. Defaults to false.",
                },
                "example": {
