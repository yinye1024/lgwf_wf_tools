...
python $lgwfPy run --workflow-lgwf plugins\team-skills\skills\lgwf-wf-tools\workflows\wf-prompt-fix\wf\workflow.lgwf --work-dir plugins\team-skills\skills\lgwf-wf-tools\workflows\wf-prompt-fix\ws --input-json "{\"prompt_fix_target\":{\"target_workflow_lgwf\":\"plugins\\team-skills\\skills\\lgwf-plan\\wf\\workflow.lgwf\",\"target_package_root\":\"plugins\\team-skills\\skills\\lgwf-plan\\wf\"}}" --background
```
