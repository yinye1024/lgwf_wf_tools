...
```powershell
$lgwfPy = "plugins\team-skills\skills\lgwf-wf-tools\vendor\lgwf-client-assist\scripts\lgwf.py"
python $lgwfPy run --workflow-lgwf plugins\team-skills\skills\lgwf-wf-tools\workflows\wf-prompt-fix\wf\workflow.lgwf --work-dir plugins\team-skills\skills\lgwf-wf-tools\workflows\wf-prompt-fix\ws --input-json <json> --background
...
```powershell
$lgwfPy = "plugins\team-skills\skills\lgwf-wf-tools\vendor\lgwf-client-assist\scripts\lgwf.py"
python $lgwfPy audit plugins\team-skills\skills\lgwf-wf-tools\workflows\wf-prompt-fix\wf\workflow.lgwf
python -m unittest discover plugins\team-skills\skills\lgwf-wf-tools\workflows\wf-prompt-fix\tests
```
