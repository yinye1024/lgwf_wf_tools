...
- `04_confirm_business_flow/resources/scaffold_template_spec.md`：workflow packaged skill 的结构规范、profile 语义和路径边界。
- `04_confirm_business_flow/resources/scaffold_result_contract.md`：`scaffold_plan` 输出字段契约。
...
- 步骤设计明确引用并遵守 `04_confirm_business_flow/resources/scaffold_template_spec.md`。
