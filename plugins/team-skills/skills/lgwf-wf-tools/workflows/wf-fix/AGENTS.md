...
python $lgwfPy run --workflow-lgwf plugins\team-skills\skills\lgwf-wf-tools\workflows\wf-fix\wf\workflow.lgwf --work-dir plugins\team-skills\skills\lgwf-wf-tools\workflows\wf-fix\ws --input-json "{}" --background
...
```powershell
$lgwfPy = "plugins\team-skills\skills\lgwf-wf-tools\vendor\lgwf-client-assist\scripts\lgwf.py"
python $lgwfPy audit plugins\team-skills\skills\lgwf-wf-tools\workflows\wf-fix\wf\workflow.lgwf
python -m unittest discover plugins\team-skills\skills\lgwf-wf-tools\workflows\wf-fix\tests
```
