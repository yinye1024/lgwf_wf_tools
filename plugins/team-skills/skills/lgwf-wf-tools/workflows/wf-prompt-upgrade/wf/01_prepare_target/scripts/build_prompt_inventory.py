...
from prompt_upgrade_common import (
    load_prompt_upgrade_target,
    lgwf_dir,
    output_state,
    write_json,
    write_prompt_upgrade_target,
)
...
def _prompt_excerpt(path: Path, limit: int = 6000) -> str:
...
def main() -> None:
    target = load_prompt_upgrade_target()
